    ...
    <div class="container">
        <div class="section text-center">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <button class="btn btn-primary btn-round" type="submit">Subir nueva imagen</button>
               ...
               <div class="col-md-4">
                   <div class="panel panel-default">
                       <div class="panel-body">
                           ...
                           <button class="btn btn-danger btn-round" type="submit">Eliminar imagen</button>
                           @if ($image->featured)
                            <button type="button" class="btn btn-success btn-fab btn-fab-mini btn-round" rel="tooltip" title="Imagen destaca del producto">
